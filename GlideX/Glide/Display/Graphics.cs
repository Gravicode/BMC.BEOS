...
namespace BEOS.Drawing.Display
{
    /// <summary>
    ...
    public sealed class Graphics
    {
        ...
        private BEOS.Graph.Graphics _bitmap;
        /// <summary>
        ...
        {
            _realBitmap = new (width, height);
            unsafe
            {
                fixed (int* p = _realBitmap.RawData)
                _bitmap = new BEOS.Graph.Graphics(_realBitmap.Width, _realBitmap.Height, (uint*)p);
            }
            
            //_bitmap = Graphics.FromImage(_realBitmap);
        ...
        public void Clear()
        {
            _bitmap.Clear(Color.Black.ToArgb());
        }
        ...
        public void DrawEllipse(System.Drawing.Color colorOutline, int x, int y, int xRadius, int yRadius)
        {
            ...
            _bitmap.DrawEllipse(xRadius,yRadius,  x, y, colorOutline.ToArgb());
        }
        ...
        public void DrawImage(int xDst, int yDst, Bitmap bitmap, int xSrc, int ySrc, int width, int height)
        {
            ...
            _bitmap.DrawImage(xDst, yDst, bitmap);
        ...
        public void DrawLine(System.Drawing.Color color, int thickness, int x0, int y0, int x1, int y1)
        {
            ...
            _bitmap.DrawLine(x0, y0, x1, y1,color.ToArgb());
        ...
        {
            //var col = Color.FromArgb(opacity, colorOutline);
            //var pen = new Pen(new SolidBrush(col), thicknessOutline);
            //_bitmap.DrawRectangle(pen, x, y, width, height);
            _bitmap.DrawRectangle(x, y, width, height,colorOutline.ToArgb());
        ...
        {
            //var col = Color.FromArgb(opacity, color);
            //var brush = new SolidBrush(col);
            //var pen = new Pen(color);
            //_bitmap.FillRectangle(brush, rect.X, rect.Y, rect.Width, rect.Height);
            _bitmap.AFillRectangle(rect.X, rect.Y, rect.Width, rect.Height,color.ToArgb());
        ...
        /// <param name="x">X</param>
        /// <param name="y">Y</param>
        public void DrawText(string text, IFont font, System.Drawing.Color color, int x, int y)
        {
            //SolidBrush brush = new SolidBrush(color);
            //_bitmap.DrawString(text, font, brush, x, y);
            font.DrawString(x,y,text, _bitmap);
        ...
        /// <param name="color">Color</param>
        /// <param name="font">Font</param>
        public void DrawTextInRect(string text, int x, int y, int width, int height, System.Drawing.Color color, IFont font)
        {
            //uint dtFlags
            //SolidBrush brush = new SolidBrush(color);
        ...
        /// <param name="font">Font</param>
        /// <returns></returns>
        public bool DrawTextInRect(ref string text, ref int xRelStart, ref int yRelStart, int x, int y, int width, int height, System.Drawing.Color color, IFont font)
        {
            //uint dtFlags
            //SolidBrush brush = new SolidBrush(color);
            //_bitmap.DrawString(text, font, brush, new RectangleF(x, y, width, height), format);
        ...
        /// <param name="color">Color</param>
        /// <param name="font">Font</param>
        public void DrawTextInRect(string text, Geom.Rectangle rect, System.Drawing.Color color, IFont font)
        {
            //uint dtFlags
            //SolidBrush brush = new SolidBrush(color);
            //_bitmap.DrawString(text, font, brush, new RectangleF(rect.X, rect.Y, rect.Width, rect.Height), format);
            font.DrawString(rect.X,rect.Y,text, _bitmap);
        ...
        public void Scale9Image(int xDst, int yDst, int widthDst, int heightDst, Bitmap bitmap, int leftBorder, int topBorder, int rightBorder, int bottomBorder, ushort opacity)
        {
            ...
            //_bitmap.DrawImage(bitmap, new System.Drawing.Rectangle(xDst + leftBorder, yDst + topBorder, widthDst - (leftBorder + rightBorder), heightDst - (topBorder + bottomBorder)), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
            _bitmap.DrawImage(xDst + leftBorder, yDst + topBorder, bitmap);//, new System.Drawing.Rectangle(xDst + leftBorder, yDst + topBorder, widthDst - (leftBorder + rightBorder), heightDst - (topBorder + bottomBorder)), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
        }
        ...
        public void Scale9Image(int xDst, int yDst, int widthDst, int heightDst, Bitmap bitmap, int border, ushort opacity)
        {
            ...
            //set the color(opacity) of the image  
            //attributes.SetColorMatrix(matrix, ColorMatrixFlag.Default, ColorAdjustType.Bitmap);
            _bitmap.DrawImage(xDst + border, yDst + border, bitmap);//, new System.Drawing.Rectangle(xDst + border, yDst + border, widthDst - border, heightDst - border), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
        }
        ...
        public void SetClippingRectangle(int x, int y, int width, int height)
        {
            ...
            //_bitmap.SetClip(new System.Drawing.Rectangle(x, y, width, height));
        }
        ...
        public void StretchImage(int xDst, int yDst, Bitmap bitmap, int width, int height, ushort opacity)
        {
            ...
            //_bitmap.DrawImage(bitmap, new System.Drawing.Rectangle(xDst, yDst, width, height), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
            _bitmap.DrawImage(xDst, yDst, bitmap);//, new System.Drawing.Rectangle(xDst, yDst, width, height), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
