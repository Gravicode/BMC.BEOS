...
namespace BEOS.Drawing.UI
{
    ...
    {
        private Bitmap _CheckBox_On = ResourceHelper.GetBitmap(Resources.CheckBox_On);
        private Bitmap _CheckBox_Off = ResourceHelper.GetBitmap(Resources.CheckBox_Off);
