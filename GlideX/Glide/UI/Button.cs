...
namespace BEOS.Drawing.UI
{
    ...
    public class Button : DisplayObject
    {
        ...
        public override void Render()
        {
            ...
            Parent.Graphics.DrawTextInRect(Text, x, textY, Width, Height, (Enabled) ? FontColor : DisabledFontColor, Font);
        }
        ...
        /// </summary>
        public Bitmap ButtonUp = ResourceHelper.GetBitmap(Resources.Button_Up);

        /// <summary>
        /// Bitmap that represents the down state.
        /// </summary>
        public Bitmap ButtonDown = ResourceHelper.GetBitmap(Resources.Button_Down);
        ...
        public Font Font = ResourceHelper.GetFont(12, FontStyle.Regular); //Resources.FontResources.droid_reg12);
