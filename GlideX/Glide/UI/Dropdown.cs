...
namespace BEOS.Drawing.UI
{
    ...
    {
        private Bitmap _DropdownText_Up = ResourceHelper.GetBitmap(Resources.DropdownText_Up);
        private Bitmap _DropdownText_Down = ResourceHelper.GetBitmap(Resources.DropdownText_Down);
        private Bitmap _DropdownButton_Up = ResourceHelper.GetBitmap(Resources.DropdownButton_Up);
        private Bitmap _DropdownButton_Down = ResourceHelper.GetBitmap(Resources.DropdownButton_Down);
        ...
        public override void Render()
        {
            ...
            Parent.Graphics.DrawTextInRect(Text, x + _leftMargin, textY, Width, Height, FontColor, Font);
        }
