...
using Point = BEOS.Drawing.Geom.Point;
...
namespace BEOS.Drawing.UI
{
    ...
    {
        private Bitmap _Button_Up = ResourceHelper.GetBitmap(Resources.Button_Up);
        private Bitmap _Button_Down = ResourceHelper.GetBitmap(Resources.Button_Down);
