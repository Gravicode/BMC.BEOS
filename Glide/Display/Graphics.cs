...
namespace BEOS.Drawing.Display
{
    ...
    public sealed class Graphics
    {
        ...
        public void Scale9Image(int xDst, int yDst, int widthDst, int heightDst, Bitmap bitmap, int border, ushort opacity)
        {
            ...
            //set the color(opacity) of the image  
            attributes.SetColorMatrix(matrix, ColorMatrixFlag.Default, ColorAdjustType.Bitmap);
            _bitmap.DrawImage(bitmap, new System.Drawing.Rectangle(xDst + border, yDst + border, widthDst - border, heightDst - border), 0, 0, bitmap.Width, bitmap.Height, GraphicsUnit.Pixel, attributes);
        }
