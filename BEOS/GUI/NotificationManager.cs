...
#if Bahasa
            Add(new Nofity("Selamat Datang di BEOS"));
            Add(new Nofity(Audio.HasAudioDevice ? "Info: kontrol Audio tersedia" : "Perhatian: Tidak ditemukan kontrol audio", Audio.HasAudioDevice ? NotificationLevel.None : NotificationLevel.Error));
            //Add(new Nofity(HID.Mouse ? "Info:USB Mouse Ada" : "Perhatian: USB Mouse tidak ada", HID.Mouse ? NotificationLevel.None : NotificationLevel.Error));
            //Add(new Nofity(HID.Keyboard ? "Info: USB Keyboard ada" : "Perhatian: USB Keyboard ga ada", HID.Keyboard ? NotificationLevel.None : NotificationLevel.Error));
            if (VMwareTools.Available)
                Add(new Nofity("VMware Tools berfungsi", NotificationLevel.None));
#else
            Add(new Nofity("Welcome to BEOS"));
