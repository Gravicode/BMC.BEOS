...
#if Bahasa
            string Result = $"FPS:{Program.fpsMeter.FPS} | Pakai CPU:{ThreadPool.CPUUsage}% | Pakai RAM: {(Allocator.MemoryInUse / 1024)}kbytes | {RTC.Hour}:{(RTC.Minute < 10 ? "0" : "")}{RTC.Minute}";
#else
        ...
        public static void OnClick(string name, bool isDirectory, int itemX, int itemY)
        {
            ...
            else if (name.EndsWith(".wav"))
            {
                ...
                else
                {
                    ...
                    msgbox.Y = itemY + 75;
#if Bahasa
                msgbox.SetText("Kontrol Audio tidak tersedia!");
#else
            ...
            else
            {
                ...
                msgbox.Y = itemY + 75;
#if Bahasa
                msgbox.SetText("Tidak ada aplikasi yang bisa buka file ini!");
#else
